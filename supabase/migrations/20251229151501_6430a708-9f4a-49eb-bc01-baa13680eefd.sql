-- RPC para métricas de telemarketing sem limite de 1000 linhas
...
BEGIN
  -- Total de leads trabalhados no período (por date_modify)
  SELECT COUNT(*)
  INTO v_total_leads
  FROM leads
  ...
  -- Total de agendamentos criados no período (por data_criacao_agendamento)
  SELECT COUNT(*)
  INTO v_agendamentos
  FROM leads
  ...
  -- Estatísticas por scouter (fonte Scouter - Fichas)
