-- Fix: get_telemarketing_conversations overload with p_offset was referencing non-existent leads.bitrix_id
-- whatsapp_messages.bitrix_id stores leads.id as text
