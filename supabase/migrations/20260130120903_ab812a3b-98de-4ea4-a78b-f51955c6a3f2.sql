-- ============================================
-- Correção: Alterar p_tag_filter de text[] para uuid[]
-- Problema: uuid = text não é uma comparação válida em PostgreSQL
-- ============================================

-- Corrigir RPC get_admin_whatsapp_conversations
...
-- Corrigir RPC count_admin_whatsapp_conversations
...
-- Corrigir RPC get_admin_whatsapp_filtered_stats
