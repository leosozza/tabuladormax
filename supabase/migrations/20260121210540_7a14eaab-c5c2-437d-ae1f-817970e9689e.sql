-- Update functions to handle both 'Lead convertido' and 'CONVERTED' as convertido etapa
-- Also treat empty/null etapa filter properly
...
BEGIN
  ...
  WHERE 
    ...
    -- Etapa filter: treat 'Lead convertido' to also match 'CONVERTED'
...
-- Update count function with the same logic
