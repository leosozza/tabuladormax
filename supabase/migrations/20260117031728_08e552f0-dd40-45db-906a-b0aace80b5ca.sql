...
-- Correção do tipo de retorno: lead_id deve ser BIGINT (não INTEGER)

DROP FUNCTION IF EXISTS get_scouter_leads_simple(TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER, INTEGER, TEXT, TEXT, TEXT);
...
GRANT EXECUTE ON FUNCTION get_scouter_leads_simple(TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER, INTEGER, TEXT, TEXT, TEXT) TO anon, authenticated;
