-- Fix RPCs used by /whatsapp admin monitoring
-- Root cause: functions were referencing leads.numero_contrato (doesn't exist) and had mismatched param types.

-- Replace the overloads that include p_closed_filter (the frontend sends this param).
