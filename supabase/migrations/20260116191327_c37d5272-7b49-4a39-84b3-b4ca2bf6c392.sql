-- Drop and recreate with correct column name (leads.name instead of leads.title)
...
-- Recreate get_admin_whatsapp_conversations with correct leads.name
...
-- Recreate count_admin_whatsapp_conversations with correct leads.name
