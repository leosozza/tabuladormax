...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Maxfama - Gestão de Leads por Scouter',
        short_name: 'Maxfama',
        description: 'Dashboard profissional para gestão de leads da Maxfama com KPIs, análises inteligentes e visualizações de performance por scouter e projeto.',
        theme_color: '#ec4899',
