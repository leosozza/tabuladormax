    ...
    <div className="flex flex-col items-center group">
      <div 
        className={cn(
          ...
          !selected && "group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-emerald-500/30"
        )}
      >
      ...
      <Handle
        ...
        className="!w-3 !h-3 !bg-emerald-500 !border-2 !border-white dark:!border-emerald-300 !-bottom-1.5"
      />
    </div>
  );
});
