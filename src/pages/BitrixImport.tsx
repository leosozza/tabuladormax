...
import { ArrowLeft, Download, Loader2, Pause, Play, Info, Database, Clock } from "lucide-react";
import UserMenu from "@/components/UserMenu";

export default function BitrixImport() {
      ...
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">Importação do Bitrix</h1>
              <p className="text-sm text-muted-foreground">
                Importe leads do Bitrix em lote por período
              </p>
            </div>
          </div>
          <UserMenu />
