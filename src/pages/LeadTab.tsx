...
import { ArrowLeft, Edit, HelpCircle, Loader2, X, Settings, Plus, Minus, Search, Info, GripVertical, ChevronUp, ChevronDown, BarChart3, RefreshCw, MessageCircle } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="p-6 flex flex-col items-start gap-4 h-fit relative">
            <div className="absolute top-4 right-4 gap-2 flex flex-col">
              ...
              {chatwootData?.conversation_id && <Button variant="outline" size="icon" onClick={() => setChatModalOpen(true)} title="Abrir Chat">
